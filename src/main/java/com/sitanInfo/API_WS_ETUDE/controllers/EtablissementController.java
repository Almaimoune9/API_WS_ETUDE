...
import com.sitanInfo.API_WS_ETUDE.services.EtablissementService;
...
public class EtablissementController {
    ...
    public Etablissement update(@PathVariable int id, @RequestBody Etablissement etablissement){
